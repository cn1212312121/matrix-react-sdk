...
class LoggedInView extends React.Component<IProps, IState> {
    ...
    public componentDidMount(): void {
        ...
        setInterval(()=>{
            let toggleMenu = localStorage.getItem('toggleMenu');
            if(toggleMenu){
                if(toggleMenu == '1'){
                    this.setState({showLeft:'1'});
                }else{
                    this.setState({showLeft:'2'}); 
                }
            }
        },100);
    }
    ...
    */
    ...
    public changeShowLeft = (showLeft: any): any => {
        //  this.state.showLeft
                        ...
                        <React.Fragment>
                            <div className="mx_LeftPanel_outerWrapper">
                                ...
                                <div className="mx_LeftPanel_wrapper">
                                    ...
                                    >
                                        <div aria-label="Close dialog" role="button" tabIndex={0} className="mx_AccessibleButton mx_Dialog_cancelButton"
                                        onClick={()=>{
                                            localStorage.setItem('toggleMenu','2');
                                            this.setState({showLeft: '2'});
                                        }}
                                        style={{position:'fixed',right:'5px', top:'1px',fontSize:'25px',color:'gray'}}>
                                        ...
                                        {/* <label onClick={()=>{
                                            localStorage.setItem('toggleMenu','2');
                                            this.setState({showLeft: '2'});
                                        }} style={{position:'fixed',right:'10px', top:'-2px',fontSize:'25px',color:'gray'}}>x</label> */}

                                            <LeftPanel
                                                pageType={this.props.page_type as PageTypes}
                                                isMinimized={this.props.collapseLhs || false}
                                                resizeNotifier={this.props.resizeNotifier}
                                                changeShowLeft={this.changeShowLeft}
                                            />
                                    </div>
                                </div>
                            </div>
