    ...
    if (activeSpace && (showCreateRooms || showInviteUsers)) {
        ...
        return (
            <AccessibleTooltipButton
                tabIndex={tabIndex}
                onClick={(e) => {
                    console.log("AccessibleTooltipButton");
                    //this.props.changeShowLeft(2);
        ...
        contextMenuContent = (
            <IconizedContextMenuOptionList first>
                <IconizedContextMenuOption
                    ...
                    onClick={(e) => {
                        console.log("IconizedContextMenuOption");
                        //this.props.changeShowLeft(2);
                        e.preventDefault();
                        e.stopPropagation();
                        closeMenu();
                ...
                {showCreateRoom ? (
                    <>
                        <IconizedContextMenuOption
                            ...
                            onClick={(e) => {
                                console.log("IconizedContextMenuOption 1");
                                //this.props.changeShowLeft(2);
                                e.preventDefault();
                                e.stopPropagation();
                                closeMenu();
                        ...
                        {videoRoomsEnabled && (
                            <IconizedContextMenuOption
                                ...
                                onClick={(e) => {
                                    console.log("IconizedContextMenuOption 2");
                                    //this.props.changeShowLeft(2);
                                    e.preventDefault();
                                    e.stopPropagation();
                                    closeMenu();
                        ...
                        <IconizedContextMenuOption
                            ...
                            onClick={(e) => {
                                console.log("IconizedContextMenuOption 3");
                                //this.props.changeShowLeft(2);
                                e.preventDefault();
                                e.stopPropagation();
                                closeMenu();
            ...
            <IconizedContextMenuOptionList first>
                {showCreateRoom && (
                    <>
                        <IconizedContextMenuOption
                            ...
                            iconClassName="mx_RoomList_iconNewRoom"
                            onClick={(e) => {
                                console.log("IconizedContextMenuOption 4");
                                //this.props.changeShowLeft(2);
                                e.preventDefault();
                                e.stopPropagation();
                                closeMenu();
                        ...
                        {videoRoomsEnabled && (
                            <IconizedContextMenuOption
                                ...
                                iconClassName="mx_RoomList_iconNewVideoRoom"
                                onClick={(e) => {
                                    console.log("IconizedContextMenuOption 5");
                                    //this.props.changeShowLeft(2);
                                    e.preventDefault();
                                    e.stopPropagation();
                                    closeMenu();
                ...
                {showExploreRooms ? (
                    <IconizedContextMenuOption
                        ...
                        iconClassName="mx_RoomList_iconExplore"
                        onClick={(e) => {
                            console.log("IconizedContextMenuOption 6");
                                    //this.props.changeShowLeft(2);
                            e.preventDefault();
                            e.stopPropagation();
                            closeMenu();
