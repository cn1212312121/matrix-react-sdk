...
export default class RoomSublist extends React.Component<IProps, IState> {
    ...
    private renderVisibleTiles(): React.ReactElement[] {
        ...
        if (this.state.rooms) {
            ...
            for (const room of visibleRooms) {
                tiles.push(
                    <RoomTile
                        changeShowLeft={this.props.changeShowLeft}
                        room={room}
    ...
    public render(): React.ReactElement {
        ...
        if (this.state.roomsLoading) {
            content = <div className="mx_RoomSublist_skeletonUI abc" />;
            ...
            content = (
                <div className="mx_RoomSublist_resizeBox mx_RoomSublist_resizeBox_forceExpanded" >
                    <div className="mx_RoomSublist_tiles" ref={this.tilesRef} onClick={()=>{console.log('1')}}>
            ...
            if (maxTilesPx > this.state.height || hasMoreSlidingSync) {
                ...
                let showMoreText: ReactNode = <span className="mx_RoomSublist_showNButtonText" onClick={()=>{console.log('2')}}>{label}</span>;
                ...
                let showLessText: ReactNode = <span className="mx_RoomSublist_showNButtonText" onClick={()=>{console.log('3')}}>{label}</span>;
            ...
            content = <div className="mx_RoomSublist_skeletonUI" onClick={()=>{console.log('5')}}/>;
        }
